...
class CropImagePage extends StatelessWidget {
  ...
  Future<void> _saveImageToBackend(BuildContext context, String imagePath) async {
    try {
      final File imageFile = File(imagePath);
      final pdfBytes = await generatePdfWithImage(imageFile);
      if (pdfBytes != null) {
        await _viewPdfResults(context);
      } else {
        print('Failed to generate PDF with image');
      }
    } catch (e) {
  ...
  Future<Uint8List?> generatePdfWithImage(File imageFile) async {
    try {
      ...
      print('Error generating PDF with image: $e');
      return null;
    }
  }
          ...
          Padding(
            ...
            child: Align(
              ...
              child: ElevatedButton(
                onPressed: () {
                  _saveImageToBackend(context, imagePath);
                },
